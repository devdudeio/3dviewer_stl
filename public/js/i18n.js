...
export const STRINGS = {
  en: {
    ...
    'drop.title': 'Drop an STL or GLB file to view it',
    'drop.hint': 'The file is read in your browser and never uploaded.',
    'file.open': 'Open STL / GLB…',
    'file.restore': 'Back to the NIH 3D model',
    'file.local': 'Local file — read in your browser, never uploaded',
    'upaxis.label': 'Up axis',
    'loading.reading': (name) => `Reading ${name}…`,
    'error.unsupported': 'Unsupported file. Drop a binary/ASCII STL or a self-contained GLB.',
    'error.noMesh': 'That file contains no mesh.',
  ...
  de: {
    ...
    'facts.unknown': 'unbekannt',
    'drop.title': 'STL- oder GLB-Datei hierher ziehen',
    'drop.hint': 'Die Datei wird im Browser gelesen und nicht hochgeladen.',
    'file.open': 'STL / GLB öffnen…',
    'file.restore': 'Zurück zum NIH-3D-Modell',
    'file.local': 'Lokale Datei — im Browser gelesen, nicht hochgeladen',
    'upaxis.label': 'Hochachse',
    'loading.reading': (name) => `${name} wird gelesen…`,
    'error.unsupported': 'Nicht unterstützte Datei. Bitte eine binäre/ASCII-STL oder eine eigenständige GLB verwenden.',
    'error.noMesh': 'Diese Datei enthält kein Mesh.',
